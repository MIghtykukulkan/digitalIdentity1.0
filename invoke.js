...
function addDocument(params) {
    ...
    Promise.resolve().then(() => {
        ...
        var request = {
            ...
            chaincodeId: options.chaincode_id,
            fcn: 'addDocument',
            args: [docDetails.rapidID, docDetails.rapid_doc_ID],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
...
function shareDocument(params) {
    ...
    Promise.resolve().then(() => {
        ...
        var request = {
            ...
            chaincodeId: options.chaincode_id,
            fcn: 'shareDocument',
            args: [sharedDocs.rapidID, sharedDocs.rapid_doc_ID, sharedDocs.OrgID],
            chainId: options.channel_id,
            txId: tx_id
        };
        console.log(request)
...
function removedocs(params) {
    ...
    Promise.resolve().then(() => {
        ...
        var request = {
            ...
            chaincodeId: options.chaincode_id,
            fcn: 'removeDocument',
            args: [deleteDocs.rapidID, deleteDocs.rapid_doc_ID],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
